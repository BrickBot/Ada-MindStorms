...
--To add a new builtin procedure or change the name of an existing one:
...
--   5) Add any appropriate constraint checks in Check_NQC_Constraints in trans_model.adb
--   6) Add an appropriate record to the Procedure_Info_Table below
--   7) Rebuild ada2nqc
...
Max_Procedures : constant Integer := 128;   --max num of procedures the tool can handle, including builtins
...
Procedure_Info_Table : Procedure_Info_Array_Type := (   
   ...
   34 => (
      ...
      Formal_Parameters => (
         ...
         others => To_Unbounded_String(""))),  
   35 => (
      Name => To_Unbounded_String("Display_Value"),
      Arity => 2,
      Formal_Parameters => (
         1 => To_Unbounded_String("Value"),
         2 => To_Unbounded_string("Decimal_Places"),
         others => To_Unbounded_String(""))),
   36 => (
      Name => To_Unbounded_String("Get_Sensor_Type"),
      Arity => 1,
      Formal_Parameters => (
         1 => To_Unbounded_String("Sensor"),
         others => To_Unbounded_String(""))),
   37 => (
      Name => To_Unbounded_String("Get_Sensor_Mode"),
      Arity => 1,
      Formal_Parameters => (
         1 => To_Unbounded_String("Sensor"),
         others => To_Unbounded_String(""))),
   38 => (
      Name => To_Unbounded_String("Get_Boolean_Sensor_Value"),
      Arity => 1,
      Formal_Parameters => (
         1 => To_Unbounded_String("Sensor"),
         others => To_Unbounded_String(""))),
   39 => (
      Name => To_Unbounded_String("Get_Raw_Sensor_Value"),
      Arity => 1,
      Formal_Parameters => (
         1 => To_Unbounded_String("Sensor"),
         others => To_Unbounded_String(""))),
   40 => (
      Name => To_Unbounded_String("Get_Output_Mode"),
      Arity => 1,
      Formal_Parameters => (
         1 => To_Unbounded_String("Output"),
         others => To_Unbounded_String(""))),
   41 => (
      Name => To_Unbounded_String("Set_Global_Output_Direction"),
      Arity => 2,
      Formal_Parameters => (
         1 => To_Unbounded_String("Output"),
         2 => To_Unbounded_String("Direction"),
         others => To_Unbounded_String(""))),
   42 => (
      Name => To_Unbounded_String("Set_Global_Output_Mode"),
      Arity => 2,
      Formal_Parameters => (
         1 => To_Unbounded_String("Output"),
         2 => To_Unbounded_String("Mode"),
         others => To_Unbounded_String(""))),
   43 => (
      Name => To_Unbounded_String("Set_Max_Power"),
      Arity => 2,
      Formal_Parameters => (
         1 => To_Unbounded_String("Output"),
         2 => To_Unbounded_String("Limit"),
         others => To_Unbounded_String(""))),
   44 => (
      Name => To_Unbounded_String("Clear_Sound_Buffer"),
      Arity => 0,
      Formal_Parameters => (
         others => To_Unbounded_String(""))),
   45 => (
      Name => To_Unbounded_String("Speaker_Off"),
      Arity => 0,
      Formal_Parameters => (
         others => To_Unbounded_String(""))),
   46 => (
      Name => To_Unbounded_String("Speaker_On"),
      Arity => 0,
      Formal_Parameters => (
         others => To_Unbounded_String(""))),
   --watch for bumping into Max_Procedures limit with the last entry above
   others => ( 
